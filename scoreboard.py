...
class Scoreboard():
    ...
    def prep_high_score(self):
        ...
        # Center the high score image at the top center of the screen.
    ...
    def prep_level(self):
        ...
        self.level_image = self.font.render(f"Level: {str(self.stats.level)}", True, self.text_color, self.ai_settings.bg_color)
    ...
    def prep_ships(self):
        ...
        self.ships = Group()
        for ship_number in range(self.stats.left_ships):
